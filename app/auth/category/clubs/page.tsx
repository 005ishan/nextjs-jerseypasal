...
export default function Page() {
  ...
  const addToCart = async (productId: string) => {
    try {
      ...
      await axios.post(`/api/users/${user._id}/cart`, { productId, quantity: 1, size: selectedSize });
    ...
    <section className="bg-gray-950 min-h-screen text-white py-14">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 flex items-center gap-4">
          <h1 className="text-4xl font-bold">Club Jerseys</h1>
          {loading && (
            ...
            : products.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-center mt-3 font-medium">Rs. {product.price}</p>
